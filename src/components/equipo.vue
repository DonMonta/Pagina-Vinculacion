            ...
            <div class="event-carousel owl-carousel">
                <div class="event-item">
                    ...
                    <div class="event-content p-4">
                        ...
                        <h4 class="mb-4">Nombre 1</h4>
                        <p class="mb-4">Facultad</p>
                        <a class="btn-hover-bg btn btn-primary text-white py-2 px-4" href="#">Ver Más Información </a>
                    </div>
                </div>
                <div class="event-item">
                    <img src="@/assets/img/img/logovincusinfondo.png" class="img-fluid w-100" alt="Image">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-member d-flex align-items-start">
                        ...
                        <div class="member-info">
                            ...
                            <div class="social">
                                <a href=""><i class="bi bi-twitter-x text-secondary"></i></a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="funcionesModal1Label">
                        Funciones del Director(a) de Vinculación con la Sociedad
                    </h5>
