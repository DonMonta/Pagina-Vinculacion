<template>
  ...
  <div class="container-fluid formLogin py-5">
    <div class="row py-5">
      <div
          ...
          <div class="authfy-login">
            ...
            <div class="authfy-panel panel-login text-center active">
              <div class="authfy-heading">
                ...
                <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup" href="#">Sign Up Free!</a>
                </p>
              </div>
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <form name="loginForm" class="loginForm" action="#" method="POST">
                    ...
                    <div class="form-group">
                      <a href="" target="_blank" class="btn btn-lg btn-primary btn-block" type="button">Login with
                        email</a>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  ...
                  <form name="signupForm" class="signupForm" action="#" method="POST">
                    ...
                    <div class="form-group">
                      <p class="term-policy text-muted small">I agree to the <a href="#">privacy policy</a> and <a
      ...
      <g id="XMLID5">
        <g id="eye2">
          ...
          <g id="XMLID63">
            <path id="Vector_3"
              d="M45.7 128.6C40.6 128.2 35.5 127.8 30.4 127.4C33 107.8 31.8 88.1 27.2 69.3C30.8 68.3 34.4 67.2 38 66.1C44.4 85.9 47.1 107.1 45.7 128.6Z"
              stroke="#2A2A2A" stroke-width="6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
          </g>
          <g id="XMLID44">
            <g id="XMLID 49">
              <path id="XMLID 51"
        ...
        <path id="XMLID 56"
          d="M17.9 166.4C17.9 166.4 24.8 170.3 48.1 164C48.3 172.6 35.3 193.6 18.1 195.7C19.1 193.9 25.2 182.2 25.7 174C25.7 172.5 26.3 168.6 25.8 167.6C20.6 167.6 17.9 166.4 17.9 166.4Z"
          stroke="#2A2A2A" stroke-width="6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path id="XMLID 55" d="M45.3 158.8C45.6 159.1 50.4 163.7 51.7 168.5" stroke="#2A2A2A" stroke-width="6"
